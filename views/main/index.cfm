 <!---
 <cfquery name="getinfo" datasource="testappdb" result="result">
	SELECT 1 FROM "INFORMATION_SCHEMA"."TABLES" WHERE "TABLE_NAME" = 'cfmigrations' 
	<!---AND "table_schema" = 'information_schema'--->
</cfquery>

<cfoutput>
	SELECT 1 FROM "INFORMATION_SCHEMA"."TABLES" WHERE "TABLE_NAME" = 'cfmigrations' ====> risultato: #result.RecordCount#
</cfoutput>
</br></br></br>
--->
